...
To clarify: For an input file with `K` samples, you will need `2K+1` files per chromosome: `K` vcf files, `K` masks generated by the calling scripts, and `1` additional mappability mask.
